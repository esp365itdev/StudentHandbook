...
import com.sp.common.utils.security.CipherUtils;
import com.sp.common.utils.spring.SpringUtils;
import com.sp.framework.config.properties.PermitAllUrlProperties;
import com.sp.framework.shiro.realm.UserRealm;
import com.sp.framework.shiro.rememberMe.CustomCookieRememberMeManager;
import com.sp.framework.shiro.session.OnlineSessionDAO;
import com.sp.framework.shiro.session.OnlineSessionFactory;
import com.sp.framework.shiro.web.CustomShiroFilterFactoryBean;
import com.sp.framework.shiro.web.filter.LogoutFilter;
import com.sp.framework.shiro.web.filter.captcha.CaptchaValidateFilter;
import com.sp.framework.shiro.web.filter.csrf.CsrfValidateFilter;
import com.sp.framework.shiro.web.filter.kickout.KickoutSessionFilter;
import com.sp.framework.shiro.web.filter.online.OnlineSessionFilter;
import com.sp.framework.shiro.web.filter.sync.SyncOnlineSessionFilter;
import com.sp.framework.shiro.web.session.OnlineWebSessionManager;
import com.sp.framework.shiro.web.session.SpringSessionValidationScheduler;
...
public class ShiroConfig
{
    ...
    {
        net.sf.ehcache.CacheManager cacheManager = net.sf.ehcache.CacheManager.getCacheManager("sp");
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        filterChainDefinitionMap.put("/sp.png**", "anon");
