package com.sp.framework.shiro.web.filter;
        ...
        try
        {
            ...
            try
            {
                ...
                if (StringUtils.isNotNull(user))
                {
                    ...
                    // 记录用户退出日志
                    //wo1AsyncManager.me().execute(AsyncFactory.recordLogininfor(loginName, Constants.LOGOUT, MessageUtils.message("user.logout.success")));
                    // 清理缓存
